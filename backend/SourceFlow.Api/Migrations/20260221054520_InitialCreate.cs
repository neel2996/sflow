    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileAnalysisCache", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProfileAnalysisCache_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileAnalysisCache_JobId",
                table: "ProfileAnalysisCache",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileAnalysisCache_ProfileUrl_JobId",
                table: "ProfileAnalysisCache",
                columns: new[] { "ProfileUrl", "JobId" },
                unique: true);
